...
- **天候が良い場合（例: 晴れ）**: 「今日は夜空が綺麗に見えるでしょう」のように、夜景や景色、快適な船旅を想起させる表現で期待感を高めてください。
- **天候が優れない場合（例: 曇り、雨）**: 船内の温かさ、快適さ、特別なイベントなどを強調し、安全で楽しいクルーズ体験を想起させる表現で期待感を高めてください。
- **お手本（晴れの場合）**: 「${timeOfDay}。今日は夜空が綺麗に見えるでしょう。絶好のクルーズ日和ですね！」
- **お手本（曇りや雨の場合）**: 「${timeOfDay}。船内では温かいお飲み物をご用意しております。快適なクルーズをお楽しみください。」
`;
        }
